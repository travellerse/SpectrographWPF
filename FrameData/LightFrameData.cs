namespace SpectrographWPF.FrameData
{
    public class LightFrameData
    {
        ...
        public static double GetX(double fe)
        {
            return F * Math.Tan(DegToRad(fe));
        }

        public static double GetFe(double x)
        {
            return Math.Atan(x / F) * 180 / Math.PI;
        }
    }
}
